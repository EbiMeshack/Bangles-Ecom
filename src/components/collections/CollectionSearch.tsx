            ...
            <div className="relative mx-auto max-w-lg">
                ...
                {!value && (
                    <div className="absolute inset-y-0 left-0 flex items-center pl-12 pointer-events-none text-lg">
                        <span className="text-muted-foreground/60 dark:text-muted-foreground/50 italic">
                            Search for{" "}
                        </span>
                        <span
                            key={placeholderIndex}
                            className="text-primary italic font-medium ml-1 animate-in fade-in slide-in-from-bottom-1 duration-300"
                        >
